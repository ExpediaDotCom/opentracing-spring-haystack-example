[![Build Status](https://travis-ci.org/ExpediaDotCom/opentracing-spring-haystack-example.svg?branch=master)](https://travis-ci.org/ExpediaDotCom/opentracing-spring-haystack-example)
